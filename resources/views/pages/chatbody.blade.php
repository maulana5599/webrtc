...
<script>
    ...
    var idChannel = '{{ $idChannel }}';
    var UserId = {{Auth::user()->id}}
    
    leaveChannel()

    async function fetchMessage (idChannel) {
    ...
    window.Echo.channel(`message-${idChannel}`)
        .listen('.MessagePrivate', function(e) {
            console.log(e, 'INI DI DALAM ECHO')
            if (e.user_id != UserId) {
    ...
    function appendMessage (data, userId) {
        if(userId != UserId) {
    ...
    function appendOneMessage (data, userId) {
        if(userId != UserId) {
    ...
    function receivedSetMessage (data) {
    ...
    function saveChannel () {
        localStorage.setItem('channel', idChannel)
    }

    function leaveChannel() {
        var channelTemp = localStorage.getItem('channel')
        window.Echo.leaveChannel(`message-${channelTemp}`)
    }
</script>